...
def create_message(habit_id):
    ...
    message = (
        f"Привет {owner}! Время {time}. Пора идти в {place} и сделать {action}. "
    ...
    if habit.linked_habit:
        ...
        message = (
            f"Молодец! Ты выполнил {action}, за это тебе подарок {pleasant_habit.action} "
